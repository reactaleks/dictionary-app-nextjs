export default function FormSkeleton() {
  ...
  <div className="flex justify-between my-4 md:my-8 items-center">
    <div className="flex flex-col">
      <div className="h-10 bg-gray-200 w-2/3 mb-4"></div>
  ...
  <div className="my-4 md:my-8">
    ...
    <div className="h-6 bg-gray-200 my-4"></div>
    <div className="h-6 bg-gray-200 my-4"></div>
    <div className="h-6 bg-gray-200 my-4"></div>
    <div className="h-6 bg-gray-200 my-4"></div>
  ...
  <div className="my-4 md:my-8">
    <div className="h-4 bg-gray-200 w-full md:w-1/2"></div>
    <div className="h-6 bg-gray-200 my-4"></div>
    <div className="h-6 bg-gray-200 my-4"></div>
    <div className="h-6 bg-gray-200 my-4"></div>
  </div>
  <div className="mb-16">
    ...
    <div className="flex flex-col md:flex-row md:items-end md:justify-between md:w-[60%]">
      <div className="h-4 bg-gray-200 w-1/3 mt-4"></div>
      <div className="h-4 bg-gray-200 w-1/3 md:w-2/3"></div>
    </div>
  </div>
</div>
    )
